...
# for n in points:
#     temp_list = pls.solve(5000, 0.01, n, n)
#     _t, _mse = pls.plot_nn(temp_list[0], temp_list[1], 5000, 0.01, n, n)
#     ax.plot(_t, _mse, lw=2, label="NN dx=dt=%.3f" %(1/n))

# ax.plot(social_network[1][0][:], social_network[1][1][:], lw=2, label="NN criteria")
...
# ax.set_yscale("log")
# ax.legend()
# figure.savefig("./figs/mse_compare_resolution.pdf")
# del ax
# plt.close(figure)
